...
export default function Header({ title, onLogout }: Props) {
    ...
    >
      ...
      <div className="relative">
        <button
          ...
          className="relative w-9 h-9 rounded-lg flex items-center justify-center text-slate-500 hover:text-slate-700"
        ...
        {showNotif && (
          ...
          >
            ...
            <div className="px-4 py-2 border-t border-slate-100">
              <button className="text-xs font-medium w-full text-center" style={{ color: '#0D6EFD' }}>
