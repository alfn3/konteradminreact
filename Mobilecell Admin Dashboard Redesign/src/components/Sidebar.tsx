...
export default function Sidebar({ screen, setScreen, collapsed, setCollapsed }: Props) {
  return (
    <aside
    ...
    >
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left relative group"
                style={{
      ...
      <div className="p-3 flex-shrink-0" style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-slate-500 hover:text-slate-300"
